...
public class ThuocTinhSua extends javax.swing.JFrame {
    ...
    public ThuocTinhSua() {
        setTitle("Sản Phẩm Sữa");
        setSize(300, 200);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Đóng form này nhưng không thoát chương trình
        setLocationRelativeTo(null); // Hiển thị form ở giữa màn hình

        // Thêm các thành phần cho form ở đây
        JLabel label = new JLabel("Đây là form sửa sản phẩm");
        add(label);
